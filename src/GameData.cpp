...
GameData::Event* GameData::Event::readJSON_L1(const ptree& pt)
{
...
void GameData::Event::readJSON_L1_vector(boost::ptr_vector<GameData::Event>& vec, const ptree& pt)
{
	vec.clear();
	vec.reserve(ptree_array_size(pt, "events"));
	ptree_array_foreach(pt, "events", [&](const ptree& item) {
		vec.push_back(GameData::Event::readJSON_L1(pt));
		});
}


GameData::Event_TrainCrash* GameData::Event_TrainCrash::readJSON_L1(const ptree& pt)
{
...
GameData::Event_Parasites* GameData::Event_Parasites::readJSON_L1(const ptree& pt)
{
...
GameData::Event_Bandits* GameData::Event_Bandits::readJSON_L1(const ptree& pt)
{
...
GameData::Event_Refugees* GameData::Event_Refugees::readJSON_L1(const ptree& pt)
{
...
GameData::Event_ResourceOverflow* GameData::Event_ResourceOverflow::readJSON_L1(const ptree& pt)
{
...
GameData::Event_ResourceLack* GameData::Event_ResourceLack::readJSON_L1(const ptree& pt)
{
...
GameData::Event_GameOver* GameData::Event_GameOver::readJSON_L1(const ptree& pt)
{
...
void GameData::Train::readJSON_L1(GameData::Train& val, const ptree& pt)
{
	...
	Event::readJSON_L1_vector(val.events, pt);
}

void GameData::Train::updateJSON(GameData::Train& val, const ptree& pt)
{
	//val.idx = pt.get<BOOST_TYPEOF(Train::idx)>("idx");
	val.tier = pt.get<BOOST_TYPEOF(Train::tier)>("tier");
	val.cooldown = pt.get<BOOST_TYPEOF(Train::cooldown)>("cooldown");
...
GameData::Post* GameData::Post::readJSON_L1(const ptree& pt)
{
	...
	Event::readJSON_L1_vector(ptr->events, pt);
}

void GameData::Post::updateJSON(GameData::Post* ptr, const ptree& pt)
{
...
GameData::Storage* GameData::Storage::readJSON_L1(const ptree& pt)
{
...
void GameData::Storage::updateJSON(Storage* ptr, const ptree& pt)
{
	ptr->armor = pt.get<BOOST_TYPEOF(Storage::armor)>("armor");
	//ptr->armor_capacity = pt.get<BOOST_TYPEOF(Storage::armor_capacity)>("armor_capacity");
	//ptr->replenishment = pt.get<BOOST_TYPEOF(Storage::replenishment)>("replenishment");
...
GameData::Market* GameData::Market::readJSON_L1(const ptree& pt)
{
...
void GameData::Market::updateJSON(Market* ptr, const ptree& pt)
{
	ptr->product = pt.get<BOOST_TYPEOF(Market::product)>("product");
	//ptr->product_capacity = pt.get<BOOST_TYPEOF(Market::product_capacity)>("product_capacity");
	//ptr->replenishment = pt.get<BOOST_TYPEOF(Market::replenishment)>("replenishment");
...
GameData::Town* GameData::Town::readJSON_L1(const ptree& pt)
{
	Town* ptr = new Town;
...
void GameData::Town::updateJSON(Town* ptr, const ptree& pt)
{
	ptr->armor = pt.get<BOOST_TYPEOF(Town::armor)>("armor");
	ptr->level = pt.get<BOOST_TYPEOF(Town::level)>("level");
	//ptr->player_idx = pt.get<BOOST_TYPEOF(Town::player_idx)>("player_idx");
...
void GameData::Player::readJSON_L1(Player& val, const ptree& pt)
{
...
void GameData::Player::updateJSON(Player& val, const ptree& pt)
{
	//val.idx = pt.get<BOOST_TYPEOF(Player::idx)>("idx");
	//val.name = pt.get<BOOST_TYPEOF(Player::name)>("name");
	val.rating = pt.get<BOOST_TYPEOF(Player::rating)>("rating");
